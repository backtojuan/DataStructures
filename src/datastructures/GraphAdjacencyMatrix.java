 ...
 * @version 1.0 - 10/2019
 */
public class GraphAdjacencyMatrix<V> implements GraphInterface<V> {
     ...
     */
    public GraphAdjacencyMatrix(boolean id) {
        initialize(DEFAULT_CAPACITY);
        isDirected = id;
    }
     ...
     */
    public GraphAdjacencyMatrix(int capacity) {
        initialize(capacity);
    }
     ...
     * @param capacity the initial size of the adjacency matrix
     */
    public GraphAdjacencyMatrix(boolean id, int capacity) {
        initialize(capacity);
        isDirected = id;
    }
