package datastructures;
	 ...
	 */
	public class GraphAdjacencyList<V> implements GraphInterface<V>{
		
		/**
		 * Map with all the vertices within the graph.
		 * Key of this map is the Vertex and Value is the position of the vertex in the adjacencyList.
		 */
		 ...
		 */
		public GraphAdjacencyList(boolean id) {
			initialize();
			isDirected = id;
		}
